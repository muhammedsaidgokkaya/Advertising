...
namespace Utilities.Utilities.GoogleData.SearchConsole
{
    ...
    public class SearchConsole
    {
		...
		public (int totalClicksSum, int totalImpressionsSum) GetAllSearchConsoleMetrics(string accessToken, List<string> accountIds)
		{
			var service = CreateSearchConsoleService(accessToken);
            ...
            if (accountIds != null)
            {
				foreach (var siteUrl in accountIds)
				{
