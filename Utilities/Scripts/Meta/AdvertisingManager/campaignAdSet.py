...
def get_facebook_adsets(access_token, ad_account_id, campaign_id, start_date, end_date):
    api_version = "v21.0"
...
if __name__ == "__main__":
    ...
    end_date = sys.argv[5]
    result = get_facebook_adsets(access_token, ad_account_id, campaign_id, start_date, end_date)
