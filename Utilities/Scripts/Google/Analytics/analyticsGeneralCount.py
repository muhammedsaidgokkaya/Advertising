...
def get_google_analytics_general_count(access_token, property_id, dimension, start_date, end_date):
...
if __name__ == "__main__":
    ...
    end_date = sys.argv[5]
    try:
        result = get_google_analytics_general_count(access_token, property_id, dimension, start_date, end_date)
